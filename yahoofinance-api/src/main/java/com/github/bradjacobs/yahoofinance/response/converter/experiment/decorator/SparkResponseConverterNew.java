...
public class SparkResponseConverterNew implements ResponseConverter
{
    ...
    public SparkResponseConverterNew() {
        this(null);
    }

    public SparkResponseConverterNew(ResponseConverterConfig config) {
        if (config == null) {
